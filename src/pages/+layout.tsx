    ...
    <main className="h-svh flex overflow-y-auto bg-[#f7f9fb] dark:bg-[#20232b]">
      ...
      >
        <div
          ...
          data-maximized={isModuleMaximized ? '' : undefined}
          className="flex-grow relative max-lg:relative max-w-[calc(100vw-74px)] max-lg:max-w-[100%] data-[maximized]:max-w-full border dark:border-none lg:shadow-[0_0_6px_rgba(0,0,0,.1)] lg:dark:shadow-[0_0_6px_rgba(0,0,0,.5)] overflow-auto data-[maximized]:absolute data-[maximized]:z-[999] data-[maximized]:inset-0 max-lg:rounded-none rounded-xl data-[maximized]:rounded-none flex-col h-full flex overflow-y-auto w-full bg-[#f5f4f3] dark:bg-[#191a19] text-black dark:text-neutral-100"
        >
          <RootHeader />
          <Outlet />
        </div>
