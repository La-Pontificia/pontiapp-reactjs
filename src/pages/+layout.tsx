...
export default function RootLayout() {
  ...
  return (
    <main className="h-svh flex overflow-y-auto dark:bg-[#1b1a19]">
      <RootSidebar />
      <UserNotices />
      <div className="w-full h-full overflow-auto flex-grow flex p-1.5 pl-0">
        ...
        <div
          ...
          className="flex-grow relative overflow-auto data-[maximized]:absolute transition-all data-[maximized]:z-[999] data-[maximized]:inset-0 shadow-sm dark:shadow-blue-950/50 rounded-xl flex-col h-full flex overflow-y-auto w-full bg-[#f1f1f2] dark:bg-[#11110f] data-[maximized]:dark:bg-[#11110f]"
        >
          <RootHeader />
          <Outlet />
        </div>
