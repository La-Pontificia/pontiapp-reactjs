...
export default function FormService({
  ...
  refetch: () => void
  defaultPosition?: AttentionPosition
}) {
  ...
  const { control, handleSubmit, reset } = useForm<FormValues>({
    values: {
      ...
      attentionPosition: defaultValues?.position ?? defaultPosition
    }
  })
  ...
  const { data: attentionPositions } = useQuery<AttentionPosition[] | null>({
