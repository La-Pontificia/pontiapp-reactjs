...
export default function AttentionsReportFilesPage() {
  ...
  return (
    <div className="w-full h-full flex flex-col">
      <Helmet>
        <title>Archivos de reportes de atenciones | PontiApp</title>
      </Helmet>
      <p className="p-3 text-xs dark:text-blue-500 text-blue-700">
        Archivos de reportes de atenciones.
      </p>
      {reports && reports?.length < 1 ? (
        <div className="grid place-content-center flex-grow">
          <img
            src="/empty-box.webp"
            width={130}
            alt="No hay archivos de reportes"
            className="mx-auto"
          />
          <p className="text-xs opacity-60">No hay archivos de reportes.</p>
        </div>
      ) : (
        <div className="pb-4">
