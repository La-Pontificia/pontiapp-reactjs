...
export default function CollaboratorsSlugLayout(): JSX.Element {
  ...
  const isRouteInternal = pathname.startsWith('/modules/collaborators')
  const rootURL = isRouteInternal ? '/modules/collaborators' : ''
      ...
      <Menu positioning={{ autoSize: true }}>
        ...
        <MenuPopover>
          <MenuList>
            <MenuItem
              onClick={() =>
                navigate(`/modules/collaborators/edit/${user.username}`)
              }
            >
              Editar usuario
            </MenuItem>
            ...
            <MenuItem>Crear un historial de cambios</MenuItem>
          </MenuList>
        </MenuPopover>
      </Menu>
