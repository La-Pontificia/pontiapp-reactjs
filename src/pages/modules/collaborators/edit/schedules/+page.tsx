...
export default function CollaboradotorsSlugSchedulesPage() {
  ...
  return (
    <div className="max-w-5xl px-4 mx-auto w-full">
      ...
      <div className="flex items-center gap-2 justify-between">
        ...
        {!isLoading && (
          <Link
            to={`/modules/collaborators/edit/${user?.id}/schedules`}
      ...
      <div>
        ...
        <div className="py-4 px-1 dark:text-stone-300 text-xs">
          ...
          <button className="dark:text-blue-500 hover:underline">
            Ver horarios deprecados
          </button>
        </div>
      </div>
    </div>
