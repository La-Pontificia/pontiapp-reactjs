...
export default function CollaboratorsEditOrganizationPage() {
  ...
  return (
    <div className="flex flex-col flex-grow">
      ...
      <div className="max-w-5xl px-4 py-3 dark:text-stone-400 w-full mx-auto">
          ...
          <>
            ...
            {data.coworkers.length > 0 && (
              <div className="max-w-5xl w-full py-4">
                ...
                <p className="text-xs dark:text-stone-400 pt-2">
      ...
      <div className="max-w-5xl px-4 py-3 text-xs dark:text-stone-400 w-full mx-auto">
